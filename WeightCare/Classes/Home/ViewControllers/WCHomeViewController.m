...
- (void)wcHomeCardSwitchViewClickIndex:(NSInteger)index {
    ...
    switch (type) {
        case WCHomeCardManagerEnumAdd: {
            UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Weight Care" message:@"添加管理卡片" preferredStyle:UIAlertControllerStyleActionSheet];
