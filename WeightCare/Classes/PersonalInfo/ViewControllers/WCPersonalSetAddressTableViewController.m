...
- (void)viewDidLoad {
    ...
    [NameLabel addObject:[NSString stringWithFormat:@"王翔"]];
    [NameLabel addObject:[NSString stringWithFormat:@"陈颖秋"]];
    [NameLabel addObject:[NSString stringWithFormat:@"吴戈"]];
    
    PhoneLabel = [[NSMutableArray alloc] init];
    [PhoneLabel addObject:[NSString stringWithFormat:@"17826808929"]];
    [PhoneLabel addObject:[NSString stringWithFormat:@"17826806857"]];
    [PhoneLabel addObject:[NSString stringWithFormat:@"17826806341"]];
